...
type SeedRoutine = Pick<Routine, 'name' | 'activeDays'> & { time?: string }
...
const SEED: SeedRoutine[] = [
  { name: 'Letrox nalačno', time: '6:00', activeDays: ALL },
  { name: 'Gym', time: '7:40', activeDays: GYM },
  { name: 'Práce / SOC', time: '9:40', activeDays: WEEKDAYS },
  { name: 'Godot / Claude Code', time: '19:00', activeDays: ALL },
  { name: 'Wizard Wars', time: '20:00', activeDays: ALL },
  { name: 'Studium / úkoly', time: '20:00', activeDays: WEEKDAYS },
  { name: 'Trading review', time: '21:00', activeDays: ALL },
  { name: 'Kalorie goal', activeDays: ALL },
  { name: 'Protein goal', activeDays: ALL },
  { name: 'Kreatin', activeDays: ALL },
  { name: 'D&D session', activeDays: WEEKEND },
  { name: 'Jít spát', time: '23:00', activeDays: ALL },
]
